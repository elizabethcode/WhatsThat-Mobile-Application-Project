...
//     const url = `http://localhost:3333/api/1.0.0/friends`;
...
//         Alert.alert('Success', 'User added as contact', [{ text: 'OK' }]);
//       } else {
//         Alert.alert('Error', 'Failed to add user as contact', [{ text: 'OK' }]);
//       }
//     } catch (error) {
//       console.log(error);
//     }
