...
// import React, { Component } from "react";
// import {View, Text, ScrollView, StyleSheet, Button, TextInput, TouchableOpacity, FlatList} from "react-native";
// import AsyncStorage from "@react-native-async-storage/async-storage";
...
//     try {
//       const response = await fetch(`http://localhost:3333/api/1.0.0/search?q=${query}&limit=${limit}&offset=${offset}`,
//         {
//           method: "GET",
//           headers: {
//             "X-Authorization": await AsyncStorage.getItem("@whatsThat_session_token"
...
//             users: [...prevState.users, ...responseJson],
//           }));
//         }
...
//     addingContactHandler = async (userId) => {
...
//         <FlatList
//           ListFooterComponent={
//             <Button title="Load More" onPress={this.loadMoreUsers} />
//           }
...
//   <Text>+</Text>
// </TouchableOpacity> */}
// <Button title="+" onPress={() => this.addingContactHandler(item.user_id)}/>
